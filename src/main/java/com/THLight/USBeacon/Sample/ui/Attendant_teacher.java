...
public class Attendant_teacher extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.attendant_teacher);
        ...
        new Thread(new Runnable(){
            ...
            public void run(){
                ...
                for (int i = 0; i < classData.size(); i++) {
                    ...
                    TableRow tableRow = new TableRow(Attendant_teacher.this);

                    TextView textView1 = new TextView(Attendant_teacher.this);
                    textView1.setId(id);
                    ...
                    TextView textView2 = new TextView(Attendant_teacher.this);
                    ...
                    TextView textView3 = new TextView(Attendant_teacher.this);
                    ...
                    TextView textView4 = new TextView(Attendant_teacher.this);
                    ...
                    TextView textView5 = new TextView(Attendant_teacher.this);
                    ...
                    Button okBtn = new Button(Attendant_teacher.this);
                    ...
                    okBtn.setOnClickListener(new Button.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            intent.setClass(Attendant_teacher.this, AllStudent_Attendant.class);
